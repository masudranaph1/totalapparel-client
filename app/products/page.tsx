...
export default function ProductsPage() {
  ...
  return (
    <main className="w-full min-h-screen bg-brand-bg relative selection:bg-brand-accent selection:text-white">
      ...
      <section className="relative h-[65vh] md:h-[75vh] w-full flex items-center justify-center overflow-hidden">
        ...
        >
          <motion.div 
            ...
            className="mb-8 px-6 py-2 rounded-full border border-white/20 bg-white/10 backdrop-blur-md text-xs tracking-[0.3em] uppercase font-bold text-white shadow-lg"
          >
            Complete Catalog
          </motion.div>
          
          <h1 className="text-5xl sm:text-7xl md:text-8xl lg:text-9xl font-medium tracking-tight text-white mb-6 drop-shadow-2xl">
            Our <span className="italic font-serif text-brand-accent">Products</span>
          </h1>
          
          <p className="text-white/80 text-lg md:text-2xl font-light max-w-2xl mx-auto tracking-wide">
      ...
      <section className="relative z-20 -mt-20 md:-mt-32 max-w-[1600px] mx-auto px-2 sm:px-4 lg:px-8 mb-32">
        <motion.div 
          ...
          className="w-full bg-white rounded-t-3xl md:rounded-[40px] shadow-[0_-20px_50px_-15px_rgba(0,0,0,0.1)] overflow-hidden"
        >
      ...
      <div className="fixed top-1/4 -left-64 w-96 h-96 bg-brand-accent/5 rounded-full blur-[100px] pointer-events-none -z-10" />
      <div className="fixed bottom-1/4 -right-64 w-96 h-96 bg-brand-dark/5 rounded-full blur-[100px] pointer-events-none -z-10" />
